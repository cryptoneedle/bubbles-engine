...
public class Result<T> implements Serializable {
    ...
    public static <T> Result<T> success(T data) {
        return success(ResultConstants.SUCCESS_MESSAGE, data);
    }
    ...
    public static <T> Result<T> failure() {
        return failure(ResultConstants.FAILURE_MESSAGE);
    }
    ...
    public Result<T> error(ErrorDetail errorDetail) {
    ...
    public Result<T> stackTrace(StackTraceElement[] stackTrace) {
        ...
        this.errorDetail.stackTrace(stackTrace);
        return this;
    }
    ...
    public Result<T> detail(String detail) {
        ...
        this.errorDetail.detail(detail);
        return this;
    }
